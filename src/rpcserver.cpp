...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"advantagecoin", "masternode", &masternode, true, true, false},
        {"advantagecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"advantagecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"advantagecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"advantagecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"advantagecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"advantagecoin", "startmasternode", &startmasternode, true, true, false},
        {"advantagecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"advantagecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"advantagecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"advantagecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"advantagecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"advantagecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"advantagecoin", "mnbudget", &mnbudget, true, true, false},
        {"advantagecoin", "preparebudget", &preparebudget, true, true, false},
        {"advantagecoin", "submitbudget", &submitbudget, true, true, false},
        {"advantagecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"advantagecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"advantagecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"advantagecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"advantagecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"advantagecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"advantagecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"advantagecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"advantagecoin", "mnsync", &mnsync, true, true, false},
        {"advantagecoin", "spork", &spork, true, true, false},
        {"advantagecoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"advantagecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use advantagecoind, or the -server option to advantagecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               "It is recommended you use the following random password:\n"
                                               "rpcuser=advantagecoinrpc\n"
                                               "rpcpassword=%s\n"
...
{
    return "> advantagecoin-cli " + methodname + " " + args + "\n";
}
