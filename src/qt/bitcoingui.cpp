...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCreditsAction->setStatusTip(tr("Request payments (generates QR codes and advantagecoin: URIs)"));
    ...
    pioAction = new QAction(QIcon(":/icons/bitcoin"), tr("&AdvantageCoin Website"), this);
        pioAction->setToolTip(tr("Visit the Official AdvantageCoin website"));
    bitcointalkAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Textile Print"), this);
        bitcointalkAction->setToolTip(tr("AdvantageCoin Own Products To Print Textile"));
    shopAction = new QAction(QIcon(":/icons/bitcoin"), tr("&My Shop"), this);
        shopAction->setToolTip(tr("AdvantageCoin Own Shop"));
    chainAction = new QAction(QIcon(":/icons/bitcoin"), tr("&AdvantageCoin Discord"), this);
        chainAction->setToolTip(tr("Join AdvantageCoin Discord"));
    explorerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&AdvantageCoin Explorer"), this);
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        tools->addAction(bitcointalkAction);
...
{
    QDesktopServices::openUrl(QUrl("http://advantagecoin.tech/"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("https://textile.advantagecoin.tech/"));
}
...
{
    QDesktopServices::openUrl(QUrl("http://explorer.advantagecoin.tech/"));
}
