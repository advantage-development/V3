...
void OverviewPage::updateObfuscationProgress()
{
    ...
    QString strAnonymizeAdvantageCoinAmount = BitcoinUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizeAdvantageCoinAmount * COIN, false, BitcoinUnits::separatorAlways);
    ...
    if (nMaxToAnonymize > nAnonymizeAdvantageCoinAmount * COIN) nMaxToAnonymize = nAnonymizeAdvantageCoinAmount * COIN;

    if (nMaxToAnonymize == 0) return;

    if (nMaxToAnonymize >= nAnonymizeAdvantageCoinAmount * COIN) {
