...
QT_MOC_LITERAL(1, 16, 9), // "sendCredits"
...
QT_MOC_LITERAL(17, 231, 5) // "begin"
    ...
    "AddressBookPage\0sendCredits\0\0addr\0done\0"
...
void AddressBookPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendCredits((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AddressBookPage::sendCredits)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void AddressBookPage::sendCredits(QString _t1)
{
