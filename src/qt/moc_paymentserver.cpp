...
QT_MOC_LITERAL(3, 38, 18), // "SendCreditsRecipient"
...
QT_MOC_LITERAL(22, 277, 16) // "handlePaymentACK"
    ...
    "\0SendCreditsRecipient\0receivedPaymentACK\0"
...
void PaymentServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receivedPaymentRequest((*reinterpret_cast< SendCreditsRecipient(*)>(_a[1]))); break;
        ...
        case 4: _t->fetchPaymentACK((*reinterpret_cast< CWallet*(*)>(_a[1])),(*reinterpret_cast< SendCreditsRecipient(*)>(_a[2])),(*reinterpret_cast< QByteArray(*)>(_a[3]))); break;
        ...
        {
            typedef void (PaymentServer::*_t)(SendCreditsRecipient );
...
// SIGNAL 0
void PaymentServer::receivedPaymentRequest(SendCreditsRecipient _t1)
{
