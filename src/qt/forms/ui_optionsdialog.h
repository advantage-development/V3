...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start AdvantageCoin after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start AdvantageCoin on system login", 0));
...
"https://www.transifex.com/advantagecoin-project/advantagecoin-project-translations", 0));
