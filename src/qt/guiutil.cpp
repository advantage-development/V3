...
#define URI_SCHEME "advantagecoin"
...
{
    // Convert advantagecoin:// to advantagecoin:
    //
    //    Cannot handle this later, because advantagecoin:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open advantagecoin.conf with the associated application */
...
{
    return GetAutostartDir() / "advantagecoin.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a advantagecoin.desktop file to the autostart directory:
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the advantagecoin app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add advantagecoin app to startup item list
