/* src/config/advantagecoin-config.h.  Generated from advantagecoin-config.h.in by configure.  */
/* src/config/advantagecoin-config.h.in.  Generated from configure.ac by autoheader.  */
