...
#include "config/advantagecoin-config.h"
#endif
...
void PrepareShutdown()
{
    ...
    RenameThread("advantagecoin-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), "advantagecoin.conf"));
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), "advantagecoind.pid"));
#endif
    ...
    string debugCategories = "addrman, alert, bench, coindb, db, lock, rand, rpc, selectcredits, mempool, net, advantagecoin, (obfuscation, swifttx, masternode, mnpayments, mnbudget)"; // Don't translate these and qt below
    if (mode == HMM_BITCOIN_QT)
        debugCategories += ", qt";
    ...
    strUsage += HelpMessageOpt("-anonymizeadvantagecoinamount=<n>", strprintf(_("Keep N USDA anonymized (default: %u)"), 0));
...
{
    RenameThread("advantagecoin-loadblk");
...
// ********************************************************* Step 8: load wallet
    ...
    nAnonymizeAdvantageCoinAmount = GetArg("-anonymizeadvantagecoinamount", 0);
