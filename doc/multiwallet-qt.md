...
In order to support loading of multiple wallets in advantagecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is advantagecoin.cpp.
...
Changes to advantagecoin.cpp
----------------------
advantagecoin.cpp is the entry point into advantagecoin-qt, and as such, will require some minor modifications to provide hooks for
