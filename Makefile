...
CONFIG_HEADER = $(top_builddir)/src/config/advantagecoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/advantagecoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/advantage/migrate/advantage-core/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/advantage/migrate/advantage-core/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/advantage/migrate/advantage-core/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/advantage/migrate/advantage-core/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/advantage/migrate/advantage-core/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/advantage/migrate/advantage-core
abs_srcdir = /home/advantage/migrate/advantage-core
abs_top_builddir = /home/advantage/migrate/advantage-core
abs_top_srcdir = /home/advantage/migrate/advantage-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/advantage/migrate/advantage-core/build-aux/install-sh
...
SUBDIRS = src
BITCOIND_BIN = $(top_builddir)/src/advantagecoind$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/advantagecoin-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/advantagecoin-cli$(EXEEXT)
...
src/config/advantagecoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/advantagecoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/advantagecoin-config.h
$(top_srcdir)/src/config/advantagecoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/advantagecoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/AdvantageCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
